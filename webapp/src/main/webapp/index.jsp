...
<head>
    <meta charset="UTF-8">
    <title>KANVI shopping website</title>
...
<body>
    ...
    <section id="home">
        <header>
            <span style="font-size:64px;margin-right:10px;color:orange"> KANVI shopping website .....</span>
            <ul id="menu">
         ...
         <h1> ****iphone, Laptop & Mobile 50% Off available, any other gadget 75% off  from 28th April 2024 till 30th april 2024**** </h1>   
	 <h1> /n if u r stupid everything is free </h1>
